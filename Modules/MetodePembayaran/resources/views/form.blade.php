                ...
                <form action="{{ isset($data)?route($attribute['link'].'update',enkrip($data->id)):route($attribute['link'].'store') }}" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input required type="text" class="form-control @error('keterangan')is-invalid @enderror" value="{{ isset($data)?$data->keterangan:old('keterangan') }}" id="keterangan" name="keterangan" placeholder="Masukan keterangan">
                            @error('keterangan')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
