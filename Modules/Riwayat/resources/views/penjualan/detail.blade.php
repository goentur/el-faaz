            ...
            <div class="card-body">
                ...
                <table class="table-sm h4">
                    <tr>
                        ...
                        <td>:</td>
                        <td class="text-end">{{ rupiah($penjualan->total) }}</td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <table class="table-sm h4">
                    <tr>
                        <td class="text-end" width="99%">TOTAL</td>
                        <td>:</td>
                        <td class="text-end">{{ rupiah($penjualan->retur->sum('total')) }}</td>
                    </tr>
                </table>
            </div>
        </div>
