...
@endpush
@push('js')<script>function data(a="semua",t="{{ enkrip('kosong') }}"){$("table#data").DataTable({ordering:!1,responsive:!0,bAutoWidth:!1,lengthMenu:[25,50,75,100],language:{url:"{{ asset('js/id.json') }}"},bDestroy:!0,processing:!0,ajax:{url:"{{ route($attribute['link'].'data') }}",type:"POST",data:{type:a,tanggal:t},error:function(a,t,n){alertApp("error","Data hutang tidak bisa ditampilkan.")}},columns:[{className:"w-1 text-center",data:"no"},{className:"w-8",data:"pengguna"},{className:"w-8",data:"pemasok"},{className:"w-6",data:"tanggal"},{className:"w-1 text-end",data:"total"},{className:"w-1 text-end",data:"bayar"},{className:"w-1 text-end",data:"kekurangan"},{data:"keterangan"},{className:"w-1 text-center",data:"aksi",render:function(a,t,n){return'<a href="'+a+'" class="btn btn-sm btn-primary mb-1"><i class="fa fa-eye"></i></a>'}},],initComplete:function(a,t){$("#textTanggalAwal").html(t.awal),$("#textTanggalAkhir").html(t.akhir)}})}$(function(){flatpickr("#tanggalTransaksi",{mode:"range",dateFormat:"d-m-Y",maxDate:"{{ $tanggalAkhir }}"}),data()}),$(document).on("click","#tampilSemua",function(){data("semua","{{ enkrip('kosong') }}")}),$("#formTanggalTransaksi").submit(function(){var a=$("#tanggalTransaksi").val();a?data("tanggal",a):alertApp("error","Pilih tanggal transaksi.")});</script>@endpush