                ...
                <div class="alert alert-info alert-dismissible" role="alert">
                    ...
                    <div class="alert-message">
                        ...
                        <ul>
                            ...
                            <li>Button <button type="button" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></button> pada kolom <b>Aksi</b> digunakan untuk memilih barang yang akan diretur.</li>
                        </ul>
                    </div>
                </div>
