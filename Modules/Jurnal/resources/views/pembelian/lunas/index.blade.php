...
@endpush
@push('js')<script>function data(a="semua",t="{{ enkrip('kosong') }}"){$("#txtTotal").html(0),totalTransaksi=0,pembelian=[],$("table#data").DataTable({ordering:!1,responsive:!0,bAutoWidth:!1,lengthMenu:[25,50,75,100],language:{url:"{{ asset('js/id.json') }}"},bDestroy:!0,processing:!0,ajax:{url:"{{ route($attribute['link'].'data') }}",type:"POST",data:{type:a,tanggal:t},error:function(a,t,e){alertApp("error","Data piutang tidak bisa ditampilkan.")}},columns:[{className:"w-1 text-center",data:"no"},{className:"w-8",data:"pengguna"},{className:"w-8",data:"pemasok"},{className:"w-6",data:"tanggal"},{className:"w-1 text-end",data:"total"},],initComplete:function(a,t){totalTransaksi=t.total,pembelian=t.pembelian,$("#txtTotal").html(currency(t.total)),$("#textTanggalAwal").html(t.awal),$("#textTanggalAkhir").html(t.akhir)}})}$(function(){var a=new Choices("select#akun",{placeholder:!0,placeholderValue:"Pilih salah satu",searchPlaceholderValue:"Masukan nama akun, minimal 2 huruf",noChoicesText:"Tidak ada pilihan",itemSelectText:"Tekan untuk memilih",noResultsText:"Tidak ada pilihan",searchResultLimit:10,removeItems:!0});a.passedElement.element.addEventListener("search",function(t){t.detail.value.length>1&&$.ajax({url:"{{ route('akun.data') }}",type:"POST",data:{nama:t.detail.value},dataType:"JSON",success:function(t){a.clearChoices(),a.setChoices(t)},error:function(a,t,e){alertApp("error","Akun tidak ditemukan")}})});let t=$("#itemForm"),e=$("#formJurnal"),n=$("#akun"),i=$("#debet"),r=$("#kredit");var l=0,s=0;let u=[];function o(){let a=$("#cartItemsBody");a.empty(),l=0,s=0,u.forEach(function(t,e){let n=$("<tr></tr>");n.html(`<td>${t.akun}</td><td align="right">${t.namaDebet}</td><td align="right">${t.namaKredit}</td><td align="center"><button onclick="removeItem(${e})" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></button></td>`),a.append(n),l+=t.debet,s+=t.kredit}),$("#txtTotalDebet").html(currency(l)),$("#txtTotalKredit").html(currency(s))}t.submit(function(a){var t;a.preventDefault();let e=n.val().trim();if(t=e,u.some(function(a){return a.idAkun===t}))alertApp("error","Akun sudah terdaftar");else{let l=$("#akun option:selected").text(),s=i.val().trim(),d=r.val().trim(),m=parseFloat(s.replace(/,/g,"")),c=parseFloat(d.replace(/,/g,""));totalTransaksi>0&&e&&l&&s&&m>=0&&m<=totalTransaksi&&d&&c>=0&&c<=totalTransaksi?(u.push({idAkun:e,akun:l,namaDebet:s,debet:m,namaKredit:d,kredit:c}),i.val(""),r.val(""),o()):alertApp("error","Nominal Debet dan/atau Kredit tidak sesuai")}}),e.submit(function(a){a.preventDefault(),loading();let t=$("#keterangan").val().trim();u.length>1&&t&&totalTransaksi>0&&l>0&&s>0&&l==s?$.ajax({url:"{{ route('jurnal.pembelian.lunas.simpan') }}",type:"POST",data:{data:u,pembelian:pembelian,keterangan:t},dataType:"JSON",success:function(a){a.status?(u=[],o(),data(),$("#keterangan").val(null),alertApp("success",a.message,!0)):alertApp("error",a.message,!0)},error:function(a,t,e){alertApp("error",e,!0)}}):alertApp("error","Form tidak memenuhi syarat",!0)}),window.removeItem=function(a){$.confirm({icon:"fa fa-warning",title:"PERINGATAN!",content:"Apakah anda yakin ingin menghapus data ini?",type:"red",autoClose:"tutup|5000",buttons:{ya:{text:"Ya",btnClass:"btn-red",action:function(){u.splice(a,1),o(),alertApp("success","Data berhasil dihapus")}},tutup:{text:"Tutup"}}})},flatpickr("#tanggalTransaksi",{mode:"range",dateFormat:"d-m-Y",maxDate:"{{ $tanggalAkhir }}"}),data()}),$(document).on("click","#tampilSemua",function(){data("semua","{{ enkrip('kosong') }}")}),$("#formTanggalTransaksi").submit(function(){var a=$("#tanggalTransaksi").val();a?data("tanggal",a):alertApp("error","Pilih tanggal transaksi.")});</script>@endpush